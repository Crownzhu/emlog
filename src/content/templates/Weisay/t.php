	...
	<div class="main">
		...
		<div id="tw">
			...
			<ul>
				...
				?> 
				<li class="li" style="border-left:10px #08D solid">
				<div class="main_img"><img src="<?php echo $avatar; ?>" width="52px" height="52px" /></div>
				...
				<div class="huifu" id="rp_<?php echo $tid;?>">   
					...
					<div class="tbutton">
						<div class="tinfo" style="display:<?php if(ROLE == 'admin' || ROLE == 'writer'){echo 'none';}?>">
							<span style="display:<?php if($reply_code == 'n'){echo 'none';}?>">验证码：<input type="text" id="rcode_<?php echo $tid; ?>" placeholder="此处填写验证码" value="" /><?php echo $rcode; ?></span> 
							<input type="text" class="name" id="rname_<?php echo $tid; ?>" placeholder="此处填写昵称" value="" />
						</div>
			...
			<div class="navigation" style="margin-right:50px;"><div class='pagination'><?php echo $pageurl;?></div></div>
		</div><!--end #tw-->
	</div>
	</div>
	﻿<div id="sidebar">
